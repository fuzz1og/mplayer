...
import { setApiBaseUrl as setCoreApiBaseUrl, setProxyUrl as setCoreProxyUrl, getApiBaseUrl, setApiTimingLog, registerDirectClient, neteaseDirectClient, qianqianDirectClient, miguDirectClient } from '@mplayer/core';
...
export default function RootLayout() {
  ...
  useEffect(() => {
    // 注册直连客户端（T02 网易 / T04 千千 / T05 咪咕）——搜索/播放 URL 可直连源站
