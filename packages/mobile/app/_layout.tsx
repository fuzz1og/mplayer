...
import { setApiBaseUrl as setCoreApiBaseUrl, setProxyUrl as setCoreProxyUrl, getApiBaseUrl, setApiTimingLog, registerDirectClient, neteaseDirectClient, qianqianDirectClient, miguDirectClient, qqDirectClient, kuwoDirectClient } from '@mplayer/core';
...
export default function RootLayout() {
  ...
  useEffect(() => {
    // 注册直连客户端（T02 网易 / T04 千千 / T05 咪咕 / T06 QQ / T08 酷我）——搜索/播放/歌词可直连源站
