...
export { musicApi, setApiBaseUrl, getApiBaseUrl, getApiClient, resolveCoverUrl, isSessionProtectedEndpoint, setProxyUrl, getProxyUrl, warmUpArtistPicCache, injectProxyAgents, setApiTimingLog, setApiRequestHandler } from './api/musicApi.js';
