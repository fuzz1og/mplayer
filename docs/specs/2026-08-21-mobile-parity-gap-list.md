...
>
> **🔧 修复落地（2026-08-21）**：八项差距已按 `docs/specs/2026-08-21-mobile-parity-fix-spec.md` 全部修复（C1 搜索腿路由化 / C2 core 兜底路由化 / C3 探测转预取+播放后徽标回写 / C4 存量迁移+tier3 统计），lint/typecheck/四套件测试全绿，**待真机复测验收**（见文末复测清单）。
